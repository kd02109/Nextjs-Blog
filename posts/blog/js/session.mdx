...
- 서버가 쿠키를 보낼 때 **쿠키에 유일하고 암호화된 ID를 부여합니다.**
  <img src="/images/session/session.png" alt="session" height="800" width="800" />
...
<img src="/images/session/session6.png" alt="session" height="300" width="800" />
...
<img src="/images/session/session2.png" alt="session" height="300" width="800" />
...
<img src="/images/session/session3.png" alt="session" height="300" width="800" />

- session으로 전달 받은 cookie의 형태
<img src="/images/session/session4.png" alt="session" height="200" width="800" />

<img src="/images/session/session5.png" alt="session" height="200" width="800" />
