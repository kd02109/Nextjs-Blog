...
tag:
  ...
  - desgin-pettern
brand: blog
description: react에서 활용되는 디자인 패턴에 대해서 학습합니다.
carousel: true
---
...
const MouseTracker = props => {
  ...
  return (
    <div onMouseMove={handleMouseMove}>{props.renderPosition(position)}</div>
  );
};
...
export default function App() {
  return (
    <ContainerComponent url={'https://api.thecatapi.com/v1/images/search'} />
  );
}
```
...
- <a
    href="https://velog.io/@dnr6054/%EC%9C%A0%EC%9A%A9%ED%95%9C-%EB%A6%AC%EC%95%A1%ED%8A%B8-%ED%8C%A8%ED%84%B4-5%EA%B0%80%EC%A7%80"
    target="_blank">
    유용한 리엑트 디자인 패턴 5가지
  </a>
- <a href="https://blog.logrocket.com/react-design-patterns/" target="_blank">
    react-design-patterns
  </a>
- <a
    href="https://javascript.plainenglish.io/5-react-design-patterns-you-should-know-629030e2e2c7"
    target="_blank">
