...
<img src="/images/react-hook-form/react-hook-form.png" alt="react-hook-form로 관리" width="600px" height="600px" />
...
<img src="/images/react-hook-form/react-hook-form1.png" alt="react-hook-form로 관리" width="600px" height="200px" />

<img src="/images/react-hook-form/react-hook-form2.png" alt="react-hook-form로 관리" width="600px" height="200px" />
      ...
      <div className="flex w-full flex-col gap-2">
         ...
         <motion.input
            ...
            className={cn(
               ...
               customError &&
                  'border-solid border-2 border-red-400 outline-none',
               className,
            )}
            disabled={disabled}
            {...props}
