---
title: useContext 이해하기
date : 2023-12-11
id : usecontext
tag: 
   - react
brand: blog
description: useContext의 기능과 활용 방법에 대해서 정리합니다.
---
...
그렇다면 state의 상태 변화를 감지하는 useState 혹은 useReducer 와 useContext를 함께 사용하면 어떤 차이가 있을까요? 
...
<img src="/images/usecontext/usecontext.png" width="700" height="500" alt="useContext" />
<img src="/images/usecontext/usecontext1.png" width="1000" height="600" alt="useContext" />
...
<img src="/images/usecontext/usecontext2.png" width="1000" height="600" alt="useContext" />
