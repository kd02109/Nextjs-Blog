...
tag: 
   - react
brand: blog
description: useState의 개념과 batch, useState를 간단하게 구현해봅니다.
---
...
다음과 같은 로직으로 인해 언제나 hook의 호출 순서는 언제나 똑같아야 합니다. 따라서 조건문이나, 반복문 내부에서 hook 호출을 리엑트는 지양합니다.
...
<img src="/images/usestate/usestate.png" width="1000" height="300" />
