---
title: MSW(Mocking Service Worker)
date: 2024-01-11
id: msw
tag:
  - msw
  ...
  - nextJs
brand: blog
description: msw를 활용하여 react롸 nextJs에서 api mocking 하는 방법을 정리합니다.
---
...
<img src="/images/msw/msw.png" alt="msw" width="900" height="600" />
...
<img src="/images/msw/msw1.png" alt="msw" width="800" height="200" />

<img src="/images/msw/msw2.png" alt="msw" width="800" height="600" />
...
<img src="/images/msw/msw3.png" alt="msw" width="800" height="500" />

`params` 에는 parameter 값,

cookies에는 해당 네트워크에 있는 `cookie`,

`request` 는 클라이언트에서 보낸 요청에 대한 상세정보가 담겨 있습니다.
...
> ❓ **tsx** ([tsx](https://www.npmjs.com/package/tsx))
>
...
- **Client**
  {' '}
  <img src="/images/msw/msw4.png" alt="msw" width="800" height="400" />
- **Server**
  {' '}
  <img src="/images/msw/msw5.png" alt="msw" width="800" height="300" />

## 참조

- [Mocking responses - msw](https://mswjs.io/docs/basics/mocking-responses)

- [http - msw](https://mswjs.io/docs/api/http)

- [HttpResponse - msw](https://mswjs.io/docs/api/http-response)

- [Describing REST API - msw](https://mswjs.io/docs/network-behavior/rest)
...
- [Next.js 와 msw 이슈](https://github.com/mswjs/msw/issues/1801)
