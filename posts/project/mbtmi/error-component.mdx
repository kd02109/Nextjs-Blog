...
description: 리엑트 클래스 컴포넌트의 getDerivedStateFromError 와 componentDidCatch의 활용 방법과 관련 라이브러리 react-error-boundary에 대해 정리했습니다.
---
...
- 성공시의 화면
  ...
  ![done](/images/error-component/done.png)

- 실패 시의 화면
  ![error](/images/error-component/error.png)
