...
description: 제어 컴포넌트와 비제어 컴포넌트의 차이에 대해서 정리했습니다.
---
...
<img src="/images/controll-component/state.png" alt="state로 관리" width="300px" height="600px" />
...
<img src="/images/controll-component/ref.png" alt="ref로 관리" width="300px" height="600px" />
