...
description: 공유 기능 구현을 위해 활용한 shareAPI에 대해 정리했습니다.
---

## 공유하기 기능 만들기

<img src="/images/shareapi/page.png" width="300px" heigth="300px" alt="결과화면"/>
...
<div className="flex justify-between items-stretch text-sm">
  <div className="flex flex-col text-sm">
    <img src="/images/shareapi/shareapi1.png" width="300px" heigth="300px" alt="윈도우 환경에서 shareAPI를 실행했을 때"/>
    <span>윈도우 환경</span>
  </div>
    <div className="flex flex-col text-sm">
      <img src="/images/shareapi/shareapi.png" width="300px" heigth="300px" alt="윈도우 환경에서 shareAPI를 실행했을 때"/>
      <span>안드로이드 환경</span>
    </div>
    <div className="flex flex-col text-sm">
      <img src="/images/shareapi/customapi.png" width="300px" heigth="300px" alt="윈도우 환경에서 shareAPI를 실행했을 때"/>
      <span>커스텀 share</span>
    </div>
</div>
...
![stack](/images/shareapi/stack.png)
